...
const SuperAdminDashboard = () => {
  ...
  const { stats: changeRequestStats, fetchStats } = useCompanyChangeRequestREST();

  // Fetch change request stats on mount
  useEffect(() => {
    fetchStats();
  }, [fetchStats]);
      ...
      <SuperAdminOnly>
        <div className="page-wrapper">
          <div className="content">
            ...
            {/* Pending Change Requests Widget */}
            {changeRequestStats && changeRequestStats.pending > 0 && (
              <div className="row mt-3">
                <div className="col-12">
                  <div className="alert alert-info d-flex align-items-center justify-content-between" role="alert">
                    <div className="d-flex align-items-center">
                      <span className="avatar avatar-md bg-info text-white me-3">
                        <i className="ti ti-file-text fs-20" />
                      </span>
                      <div>
                        <h6 className="mb-1">
                          {changeRequestStats.pending} Pending Company Change Request{changeRequestStats.pending !== 1 ? 's' : ''}
                        </h6>
                        <p className="mb-0 fs-13 text-muted">
                          Review and approve pending company information change requests from admins
                        </p>
                      </div>
                    </div>
                        ...
                        >
                          <div className="d-flex align-items-center mb-2">
                            <Link
                              ...
                              title={`View ${transaction.company || "company"
                                } transaction`}
                              style={{
                                width: "48px",
                                height: "48px",
                            ...
                            >
                              <div className="d-flex align-items-center mb-2">
                                <Link
                                  to="#"
                                  className="avatar avatar-md bg-gray-100 rounded-circle flex-shrink-0 d-flex align-items-center justify-content-center"
                                  title={`View ${company.name || "company"
                                    } details`}
                                  style={{
                                    width: "48px",
                                    height: "48px",
