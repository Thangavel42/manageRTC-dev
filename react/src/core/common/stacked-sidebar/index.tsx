    ...
    <div className="stacked-sidebar" id="stacked-sidebar">
      <div className="sidebar sidebar-stacked" style={{ display: "flex" }}>
        ...
        <div className="sidebar-right d-flex justify-content-between flex-column">
          <div className="sidebar-scroll">
            ...
            <div className="stack-menu">
                      ...
                      {(mainMenu.menu as any[]).filter((title: any) => hasAccess(title?.roles)).map((title, i) => (
                        <div className="col-6" key={i}>
                          <Link
                            ...
                            onClick={() => {
                              showTabs(title);
                              SetShowSubMenusTab(!showSubMenusTab);
                            }}
                            className={`nav-link ${
                              title?.subMenus
              ...
              <div className="tab-content">
                <div
                  className={`tab-pane ${
                    showSubMenusTab ? "d-block" : "d-none"
                  }`}
                  id="menu-dashboard"
                >
          ...
          <div className="p-3">
            <Link to="#" className="d-flex align-items-center fs-12 mb-3">
              Documentation
            </Link>
            <Link to="#" className="d-flex align-items-center fs-12">
              Change Log
              <span className="badge bg-pink badge-xs text-white fs-10 ms-2">
                v4.0.2
              </span>
            </Link>
          </div>
