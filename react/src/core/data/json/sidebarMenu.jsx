  ...
  switch (userRole) {
    ...
    case "hr":
      ...
      console.log('[Sidebar Menu] HR Menu constructed successfully:', {
        ...
        ticketsSection: hrMenu.find(s => s.tittle === 'HRM')?.submenuItems?.filter(i => i.label === 'Tickets')?.[0]?.submenuItems?.map(i => i.label),
        attendanceSection: hrMenu.find(s => s.tittle === 'HRM')?.submenuItems?.filter(i => i.label === 'Attendance')?.[0]?.submenuItems?.map(i => i.label),
      });
      return hrMenu;
    case "manager":
      return [
