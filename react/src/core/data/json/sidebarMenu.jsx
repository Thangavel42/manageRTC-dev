...
const useSidebarData = () => {
  ...
  console.log(
    '%c=== SIDEBAR MENU DEBUG START ===',
    'background: #ff0000; color: white; font-size: 16px; font-weight: bold; padding: 5px;'
  );
  ...
  console.log(
    '[Sidebar Menu] Switch case matching for role:',
    userRole,
    '- will match hr case:',
    userRole === 'hr'
  );
  ...
  if (userRole === 'hr') {
    console.warn(
      '%c[EMERGENCY FALLBACK] Detected HR role, bypassing switch statement!',
      'background: #00ff00; color: black; font-size: 14px; font-weight: bold; padding: 5px;'
    );
  }
  ...
  switch (userRole) {
              ...
              submenuItems: [
                {
                  ...
                  submenuItems: [
                    ...
                    },
                    {
                      ...
                      link: routes.leaveCalendar,
                      submenu: false,
                      showSubRoute: false,
                    },
                    {
                      label: 'Leave Balance History',
                      link: routes.leaveLedger,
                      submenu: false,
                      showSubRoute: false,
                    },
                    {
    ...
    case 'hr':
      ...
      console.log('[Sidebar Menu] HR Menu constructed successfully:', {
        ...
        ticketsSection: hrMenu
          .find((s) => s.tittle === 'HRM')
          ?.submenuItems?.filter((i) => i.label === 'Tickets')?.[0]
          ?.submenuItems?.map((i) => i.label),
        attendanceSection: hrMenu
          .find((s) => s.tittle === 'HRM')
          ?.submenuItems?.filter((i) => i.label === 'Attendance')?.[0]
          ?.submenuItems?.map((i) => i.label),
      });
      return hrMenu;
    case 'manager':
        ...
        },
        {
          ...
          submenuItems: [
            ...
            },
            {
              ...
              submenuItems: [
                { label: 'Performance Indicator', link: routes.performanceIndicator },
                { label: 'Performance Review', link: routes.performancereview },
                { label: 'My Goals', link: routes.goallist },
              ],
            },
            {
              label: 'Training',
              ...
              submenuItems: [
                { label: 'Training List', link: routes.trainingList },
                { label: 'My Training', link: routes.myTraining },
              ],
            },
            {
              label: 'Resignation',
